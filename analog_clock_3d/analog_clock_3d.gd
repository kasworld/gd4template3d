...
func make_hands(r :float, d:float)->void:
	...
	$HourBase.position.z = hand_height*1
	$MinuteBase.position.z = hand_height*2
	$SecondBase.position.z = hand_height*3
