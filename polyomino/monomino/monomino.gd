...
func make_ani_rotation(ani_name:String, dir :Vector3, ani_sec :float) -> Dictionary:
	match dir:
		Vector3.DOWN:
...
func make_ani_color(ani_name:String, from :Color, to :Color, ani_sec :float) -> Dictionary:
